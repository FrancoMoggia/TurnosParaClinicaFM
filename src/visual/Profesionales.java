...
import controladores.ControladorProfesionalesBotConsultaPorEspecialidad;
import controladores.ControladorProfesionalesBotConsultaPorPaciente;
import controladores.ControladorProfesionalesBotRegistroDeProfesionales;
import controladores.ControladorProfesionalesBotVolverAMenuPrincipal;
import controladores.ControladorProfesionalesBotConsultaPorFecha;
...
public class Profesionales extends javax.swing.JFrame {
    ...
    public Profesionales() {
        ...
        //ControladorCxE//
   controladorCxE = new ControladorProfesionalesBotConsultaPorEspecialidad();
   botCxE.addMouseListener(controladorCxE);
   
        //ControladorCxP//
   controladorCxP = new ControladorProfesionalesBotConsultaPorPaciente();
   botCxP.addMouseListener(controladorCxP);
   
        //ControladorCxF//
   controladorCxF = new ControladorProfesionalesBotConsultaPorFecha();
   botCxF.addMouseListener(controladorCxF);
   
        //ControladorMenuPrincipal//
   controladorMenuPrincipal = new ControladorProfesionalesBotVolverAMenuPrincipal();
   botMenuPrincipal.addMouseListener(controladorMenuPrincipal);
   
        //ControladorRdP//
   controladorRdP = new ControladorProfesionalesBotRegistroDeProfesionales();
   botRegProf.addMouseListener(controladorRdP);
...
private ControladorProfesionalesBotConsultaPorEspecialidad controladorCxE;
private ControladorProfesionalesBotConsultaPorFecha controladorCxF;
private ControladorProfesionalesBotConsultaPorPaciente controladorCxP;
private ControladorProfesionalesBotRegistroDeProfesionales controladorRdP;
private ControladorProfesionalesBotVolverAMenuPrincipal controladorMenuPrincipal;
